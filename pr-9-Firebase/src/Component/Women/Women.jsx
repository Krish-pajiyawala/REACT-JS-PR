                ...
                display.map((product, index) => (
                  ...
                  >
                    <Card className="shadow-sm border-0 rounded-3 m-2" onClick={() => handleView(product.id)}>
                            ...
                            {product.image.map((_, i) => (
                              <div
                                ...
                                style={{
                                  ...
                                  height: "5px",
                                  borderRadius: "50%",
                                  backgroundColor: slideIndex === i ? "black" : "#ccc",
                                  cursor: "pointer",
                                }}
                              ></div>
                            ))}
                      ...
                      <Card.Body>
                        {hoverIndex !== index && (
                          <Card.Title className="fw-bold mb-0">{product.brand}</Card.Title>
                        )}
                          ...
                          <Card.Title className="fw-bold mb-0">
                            <div className="d-flex justify-content-center alighn-items-center border border-2">
                              <Button variant="white">
                                <small><CiHeart className="fs-5" /></small> <small>WISHLIST</small>
                              </Button>
                            </div>
                          </Card.Title>
                        )}
                        ...
                        {hoverIndex !== index && (
                          <Card.Text className="text-muted my-1">{product.title}</Card.Text>
                        )}

                        {hoverIndex == index && (
                          <Card.Text className="text-muted my-1">{"size : S"}</Card.Text>
                        )}
